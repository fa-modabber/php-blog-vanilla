...
$formErrors = [
    'email' => $_SESSION['user']['create']['form']['error']['email'] ?? "",
    'password' => $_SESSION['user']['create']['form']['error']['password'] ?? "",
];

unset($_SESSION['user']['create']['form']['error']);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <main class="form-signin w-50 m-auto mb-3">
        ...
        <form method="post">
            ...
            <button class="w-100 btn btn-dark mt-4" type="submit" name="signup">
                signup
            </button>
        </form>
    </main>
